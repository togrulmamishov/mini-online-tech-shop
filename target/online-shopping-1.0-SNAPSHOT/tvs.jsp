        ...
        <div class="row">
            ...
            <div class="col-md-8"><!-- right -->
                ...
                <c:forEach items="${list }" var="product">
                    ...
                    <c:if test="${product.getCategory() == 'tvs' }">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="text-center"><a class="btn btn-primary"
                                                        href="Controller?page=addtocart&action=tvs&id=<c:out value="${product.getId()}"/>">Add
                                to Cart</a></div>
                            <br>
                        </div>
