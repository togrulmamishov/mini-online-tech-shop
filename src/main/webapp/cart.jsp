...
<div class="container">
        ...
        <c:forEach items="${list }" var="Product">
            <c:if test="${i == Product.getId() }">
                ...
                <table style="table-layout: fixed;width: 100%;">
                    <tr>
                        <td style="width: 100px;"><img src="${Product.getImage()}" height="100" width="150"> (<c:out
    ...
    <a href="Controller?page=success"><input type="submit" value="Proceed to Checkout" class="btn btn-success"
