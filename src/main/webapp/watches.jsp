        ...
        <div class="row">
            <div class="col-md-4"><!-- left -->
                <div class="list-group"><!-- products -->
                    ...
                    <a href="Controller?page=tvs" class="list-group-item">TVs</a>
                    <a href="Controller?page=watches" class="list-group-item">Watches</a>
                </div>
            </div><!-- left -->

            <div class="col-md-8"><!-- right -->
                <h2 style="text-align: center;">Watches</h2><br>

                <h5>Sort by(Price):</h5>
                <form action="Controller" method="get"
                      style="border: none;margin:0px;padding: 0px;margin-bottom: 20px;">
                    <input type="hidden" name="page" value="price-sort">
                    <input type="hidden" name="action" value="watches">
                    <select name="sort">
                ...
                <c:forEach items="${list }" var="product">
                    ...
                    <c:if test="${product.getCategory() == 'watches' }">

                        <div class="col-md-4">
                            <img src="${product.getImage() }" class="img-responsive"><br>
                            <div class="text-center"><a style="color: black;"><c:out
                                    value="${product.getName() }"></c:out></a></div>
                            <p style="text-align: center;"> &#x20BC; <c:out value="${ product.getPrice() }"></c:out></p>
                            <div class="text-center"><a class="btn btn-primary"
                                                        href="Controller?page=addtocart&action=watches&id=<c:out value="${product.getId()}"/>">Add
                                to Cart</a></div>
                            <br></div>
...
<footer>
    <div class="footer"> &copy; 2021 Copyright:
        <a href="Controller?page=index"> Media Bazar</a>
    </div>
</footer>
